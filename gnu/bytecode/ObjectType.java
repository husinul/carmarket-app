...
public class ObjectType extends Type {
    ...
    protected ObjectType() {
        this.size = ADD_MEMBERCLASSES_DONE;
    }
    ...
    public final boolean isExisting() {
        ...
        if (t != this) {
            ...
            return z;
        } else if ((this.flags & EXISTING_CLASS) != 0) {
            return true;
        } else {
            return false;
        }
    ...
    public Class getReflectClass() {
        try {
            ...
            if ((this.flags & EXISTING_CLASS) != 0) {
