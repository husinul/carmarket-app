...
public class ClassType extends ObjectType implements AttrContainer, Externalizable, Member {
    ...
    public void setClassfileVersion(int major, int minor) {
        this.classfileFormatVersion = ((major & 65535) * ModuleExp.NONSTATIC_SPECIFIED) + (minor * 65535);
    }
    ...
    public synchronized java.lang.String getSimpleName() {
        ...
        r7 = this;
        monitor-enter(r7);
        r6 = r7.flags;	 Catch:{ all -> 0x004c }
        r6 = r6 & 16;
        if (r6 == 0) goto L_0x0016;
    L_0x0007:
        r6 = r7.getReflectClass();	 Catch:{ all -> 0x004c }
        if (r6 == 0) goto L_0x0016;
    L_0x000d:
        r6 = r7.reflectClass;	 Catch:{ Throwable -> 0x0015 }
        r4 = r6.getSimpleName();	 Catch:{ Throwable -> 0x0015 }
    L_0x0013:
        monitor-exit(r7);
        return r4;
    L_0x0015:
        r6 = move-exception;
    L_0x0016:
        r4 = r7.getName();	 Catch:{ all -> 0x004c }
        r6 = 46;
        r2 = r4.lastIndexOf(r6);	 Catch:{ all -> 0x004c }
        if (r2 <= 0) goto L_0x0028;
    L_0x0022:
        r6 = r2 + 1;
        r4 = r4.substring(r6);	 Catch:{ all -> 0x004c }
    L_0x0028:
        r6 = 36;
        r1 = r4.lastIndexOf(r6);	 Catch:{ all -> 0x004c }
        if (r1 < 0) goto L_0x0013;
    L_0x0030:
        r3 = r4.length();	 Catch:{ all -> 0x004c }
        r5 = r1 + 1;
    L_0x0036:
        if (r5 >= r3) goto L_0x0047;
    L_0x0038:
        r0 = r4.charAt(r5);	 Catch:{ all -> 0x004c }
        r6 = 48;
    ...
    L_0x0044:
        ...
        goto L_0x0036;
    L_0x0047:
        r4 = r4.substring(r5);	 Catch:{ all -> 0x004c }
        goto L_0x0013;
    L_0x004c:
        r6 = move-exception;
        monitor-exit(r7);
...
/*
	...
	at jadx.core.dex.visitors.CodeShrinker$ArgsInfo.canMove(CodeShrinker.java:130)
	at jadx.core.dex.visitors.CodeShrinker$ArgsInfo.checkInline(CodeShrinker.java:93)
	at jadx.core.dex.visitors.CodeShrinker.shrinkBlock(CodeShrinker.java:222)
...
*/
    ...
    public boolean isAccessible(ClassType declaring, ObjectType receiver, int modifiers) {
        ...
        String callerPackage = dot >= 0 ? callerName.substring(0, dot) : ElementType.MATCH_ANY_LOCALNAME;
        dot = className.lastIndexOf(46);
        if (callerPackage.equals(dot >= 0 ? className.substring(0, dot) : ElementType.MATCH_ANY_LOCALNAME)) {
            return true;
        }
        if ((cmods & 1) == 0) {
            return false;
    ...
    public String getPackageName() {
        ...
        return index < 0 ? ElementType.MATCH_ANY_LOCALNAME : name.substring(0, index);
    }
    ...
    public final boolean isInterface() {
        return (getModifiers() & Declaration.NOT_DEFINING) != 0;
    }
    ...
    public ClassType() {
        this.classfileFormatVersion = JDK_1_1_VERSION;
