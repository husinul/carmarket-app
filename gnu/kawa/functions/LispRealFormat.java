...
class LispRealFormat extends ReportFormat {
    ...
    LispRealFormat() {
        ...
        this.argsUsed = i;
        if (this.arg1 == ParseFormat.PARAM_FROM_LIST) {
            this.argsUsed += 2;
        }
        if (this.arg2 == ParseFormat.PARAM_FROM_LIST) {
            this.argsUsed += 2;
        }
        if (this.arg3 == ParseFormat.PARAM_FROM_LIST) {
            this.argsUsed += 2;
        }
        if (this.arg4 == ParseFormat.PARAM_FROM_LIST) {
            this.argsUsed += 2;
        }
        if (this.arg5 == ParseFormat.PARAM_FROM_LIST) {
            this.argsUsed += 2;
        }
        if (this.arg6 == ParseFormat.PARAM_FROM_LIST) {
            this.argsUsed += 2;
        }
        if (this.arg7 == ParseFormat.PARAM_FROM_LIST) {
            this.argsUsed += 2;
        }
    }
