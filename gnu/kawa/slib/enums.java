...
public class enums extends ModuleBody {
    ...
    static {
        ...
        Lit43 = (SimpleSymbol) new SimpleSymbol(LispLanguage.quote_sym).readResolve();
        ...
        Lit37 = new SyntaxTemplate("\u0001\u0001\u0001\u0003\u0003", "\u0018\u0004", new Object[]{PairWithPosition.make(Lit41, LList.Empty, "/u2/home/jis/ai2-kawa/gnu/kawa/slib/enums.scm", 290882)}, 0);
        ...
        Lit35 = new SyntaxTemplate("\u0001\u0001\u0001\u0003\u0003", "\u0018\u0004", new Object[]{PairWithPosition.make(Lit43, PairWithPosition.make(Lit45, LList.Empty, "/u2/home/jis/ai2-kawa/gnu/kawa/slib/enums.scm", 286739), "/u2/home/jis/ai2-kawa/gnu/kawa/slib/enums.scm", 286739)}, 0);
        Lit34 = new SyntaxTemplate("\u0001\u0001\u0001\u0003\u0003", "\u0018\u0004", new Object[]{PairWithPosition.make(Lit46, LList.Empty, "/u2/home/jis/ai2-kawa/gnu/kawa/slib/enums.scm", 286726)}, 0);
        Lit33 = new SyntaxTemplate("\u0001\u0001\u0001\u0003\u0003", "\u0018\u0004", new Object[]{PairWithPosition.make(Lit42, LList.Empty, "/u2/home/jis/ai2-kawa/gnu/kawa/slib/enums.scm", 282649)}, 0);
        Lit32 = new SyntaxTemplate("\u0001\u0001\u0001\u0003\u0003", "\u0018\u0004", new Object[]{PairWithPosition.make(Lit40, PairWithPosition.make(Lit41, PairWithPosition.make(Lit42, PairWithPosition.make(Lit47, LList.Empty, "/u2/home/jis/ai2-kawa/gnu/kawa/slib/enums.scm", 282642), "/u2/home/jis/ai2-kawa/gnu/kawa/slib/enums.scm", 282640), "/u2/home/jis/ai2-kawa/gnu/kawa/slib/enums.scm", 282639), "/u2/home/jis/ai2-kawa/gnu/kawa/slib/enums.scm", 282630)}, 0);
        Lit31 = new SyntaxTemplate("\u0001\u0001\u0001\u0003\u0003", "\u0018\u0004", new Object[]{PairWithPosition.make(Lit43, PairWithPosition.make(PairWithPosition.make(Lit52, PairWithPosition.make(Lit53, LList.Empty, "/u2/home/jis/ai2-kawa/gnu/kawa/slib/enums.scm", 266284), "/u2/home/jis/ai2-kawa/gnu/kawa/slib/enums.scm", 266278), LList.Empty, "/u2/home/jis/ai2-kawa/gnu/kawa/slib/enums.scm", 266278), "/u2/home/jis/ai2-kawa/gnu/kawa/slib/enums.scm", 266278)}, 0);
        Lit30 = new SyntaxTemplate("\u0001\u0001\u0001\u0003\u0003", "\u0018\u0004", new Object[]{PairWithPosition.make(Lit48, LList.Empty, "/u2/home/jis/ai2-kawa/gnu/kawa/slib/enums.scm", 266269)}, 0);
        Lit29 = new SyntaxTemplate("\u0001\u0001\u0001\u0003\u0003", "\u0018\u0004", new Object[]{PairWithPosition.make(Lit44, LList.Empty, "/u2/home/jis/ai2-kawa/gnu/kawa/slib/enums.scm", 266252)}, 0);
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        r16 = new Object[2];
                        r16[0] = Lit30.execute(allocVars, make);
                        Object execute6 = Lit31.execute(allocVars, make);
                        Object[] objArr3 = new Object[2];
                        objArr3[0] = std_syntax.datum$To$SyntaxObject(form, opts);
                        Object[] objArr4 = new Object[2];
                        objArr4[0] = std_syntax.datum$To$SyntaxObject(form, init);
                        Object[] objArr5 = new Object[2];
                        objArr5[0] = std_syntax.datum$To$SyntaxObject(form, values$Mnmethod);
                        Object execute7 = Lit32.execute(allocVars, make);
                        r26 = new Object[2];
                        r26[0] = Lit33.execute(allocVars, make);
                        Object[] objArr6 = new Object[2];
                        objArr6[0] = std_syntax.datum$To$SyntaxObject(form, t$Mnname);
                        r30 = new Object[2];
                        r30[0] = Lit34.execute(allocVars, make);
                        Object execute8 = Lit35.execute(allocVars, make);
                        Object execute9 = Lit36.execute(allocVars, make);
                        Object[] objArr7 = new Object[2];
                        objArr7[0] = std_syntax.datum$To$SyntaxObject(form, t$Mnname);
                        objArr7[1] = Lit37.execute(allocVars, make);
                        r30[1] = Pair.make(execute8, Pair.make(Pair.make(execute9, Quote.consX$V(objArr7)), Lit38.execute(allocVars, make)));
                        objArr6[1] = Quote.append$V(r30);
                        r26[1] = Quote.consX$V(objArr6);
                        Pair make2 = Pair.make(execute7, Quote.append$V(r26));
                        r26 = new Object[2];
                        r26[0] = std_syntax.datum$To$SyntaxObject(form, field$Mndescs);
                        objArr6 = new Object[2];
                        objArr6[0] = std_syntax.datum$To$SyntaxObject(form, other$Mndefs);
                        objArr6[1] = Lit39.execute(allocVars, make);
                        r26[1] = Quote.append$V(objArr6);
                        objArr5[1] = Pair.make(make2, Quote.append$V(r26));
                        objArr4[1] = Quote.consX$V(objArr5);
                        objArr3[1] = Quote.consX$V(objArr4);
                        r16[1] = Pair.make(execute6, Quote.append$V(objArr3));
                        objArr2[1] = Pair.make(execute5, Quote.append$V(r16));
                        objArr[1] = Quote.consX$V(objArr2);
