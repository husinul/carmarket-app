...
public class testing extends ModuleBody {
    ...
    static {
        ...
        Lit159 = (SimpleSymbol) new SimpleSymbol(GetNamedPart.INSTANCEOF_METHOD_NAME).readResolve();
    ...
    static Object $PcTestFormatLine(Object runner) {
        try {
            ...
            Object file = source$Mnfile != Boolean.FALSE ? lists.cdr.apply1(source$Mnfile) : ElementType.MATCH_ANY_LOCALNAME;
    ...
    public static Object testRunnerTestName(Object runner) {
        try {
            ...
            return p != Boolean.FALSE ? lists.cdr.apply1(p) : ElementType.MATCH_ANY_LOCALNAME;
        } catch (ClassCastException e) {
            throw new WrongType(e, "test-result-alist", 0, runner);
        }
    }
