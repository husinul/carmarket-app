...
public class swing extends ModuleBody {
    ...
    static {
        Lit26 = (SimpleSymbol) new SimpleSymbol("scroll").readResolve();
        ...
        composite$Mnsrc$Mnover = new ModuleMethod(moduleBody, 6, Lit18, LambdaExp.ATTEMPT_INLINE);
        composite$Mnsrc = new ModuleMethod(moduleBody, 8, Lit19, LambdaExp.ATTEMPT_INLINE);
