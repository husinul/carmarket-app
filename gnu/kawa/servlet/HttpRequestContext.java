...
public abstract class HttpRequestContext {
    ...
    public HttpRequestContext() {
        ...
        this.scriptPath = ElementType.MATCH_ANY_LOCALNAME;
        this.localPath = ElementType.MATCH_ANY_LOCALNAME;
    }
    ...
    public String getRequestBodyChars() throws IOException {
        ...
        int buflen = LambdaExp.SEQUENCE_RESULT;
    ...
    public ServletPrinter getConsumer() throws IOException {
        if (this.consumer == null) {
            this.consumer = new ServletPrinter(this, Declaration.TYPE_SPECIFIED);
        }
    ...
    public void sendNotFound(String path) throws IOException {
        ...
        sendResponseHeaders(HTTP_NOT_FOUND, null, (long) bmsg.length);
        try {
