...
public abstract class Path {
    ...
    public Path getDirectory() {
        return isDirectory() ? this : resolve(ElementType.MATCH_ANY_LOCALNAME);
    }

    public Path getParent() {
        return resolve(isDirectory() ? ".." : ElementType.MATCH_ANY_LOCALNAME);
    }
    ...
    public Path getAbsolute() {
        if (this == userDirPath) {
            return resolve(ElementType.MATCH_ANY_LOCALNAME);
        }
