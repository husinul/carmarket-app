...
public class QueueReader extends Reader implements Appendable {
    ...
    public synchronized int read() {
        ...
        monitor-enter(r4);
    L_0x0001:
        r1 = r4.pos;	 Catch:{ all -> 0x0022 }
        r2 = r4.limit;	 Catch:{ all -> 0x0022 }
        if (r1 < r2) goto L_0x0017;
    L_0x0007:
        r1 = r4.EOFseen;	 Catch:{ all -> 0x0022 }
    ...
    L_0x0015:
        ...
        goto L_0x0001;
    L_0x0017:
        r1 = r4.buffer;	 Catch:{ all -> 0x0022 }
        r2 = r4.pos;	 Catch:{ all -> 0x0022 }
        r3 = r2 + 1;
    ...
    L_0x000c:
        r1 = r3.pos;	 Catch:{ all -> 0x0031 }
        r2 = r3.limit;	 Catch:{ all -> 0x0031 }
        if (r1 < r2) goto L_0x0018;
    L_0x0012:
        r1 = r3.EOFseen;	 Catch:{ all -> 0x0031 }
        if (r1 == 0) goto L_0x0006;
    L_0x0016:
        r1 = -1;
        goto L_0x0004;
    L_0x0018:
        r1 = r3.limit;	 Catch:{ all -> 0x0031 }
        r2 = r3.pos;	 Catch:{ all -> 0x0031 }
        r0 = r1 - r2;
        if (r6 <= r0) goto L_0x0021;
    L_0x0020:
        r6 = r0;
    L_0x0021:
        r1 = r3.buffer;	 Catch:{ all -> 0x0031 }
        r2 = r3.pos;	 Catch:{ all -> 0x0031 }
