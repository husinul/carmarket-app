...
public class Options {
    ...
    public String set(String key, String argument) {
        ...
        if (value == null && (info.kind & BOOLEAN_OPTION) != 0) {
    ...
    public void popOptionValues(Vector options) {
        ...
        while (true) {
            ...
            if (i >= 0) {
                String key = (String) options.elementAt(i);
                Object oldValue = options.elementAt(i + BOOLEAN_OPTION);
                options.setElementAt(null, i + BOOLEAN_OPTION);
                reset(key, oldValue);
            } else {
                return;
            }
