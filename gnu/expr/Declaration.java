...
public class Declaration implements SourceLocator {
    ...
    L_0x0035:
        r32 = r22.isIndirectBinding();
        if (r32 == 0) goto L_0x0056;
    L_0x003b:
        if (r23 == 0) goto L_0x0043;
    L_0x003d:
        r32 = r22.needsContext();
        if (r32 != 0) goto L_0x0056;
    L_0x0043:
        r0 = r22;
        r1 = r25;
    ...
    L_0x005c:
        ...
        r32 = r0;
        r0 = r32;
        r0 = r0 instanceof gnu.expr.FluidLetExp;
        r32 = r0;
        if (r32 == 0) goto L_0x007e;
    L_0x006a:
        r0 = r35;
    ...
    L_0x0098:
        ...
        r33.<init>();
        r34 = "internal error: cannot take location of ";
        r33 = r33.append(r34);
        r0 = r33;
        r1 = r35;
        r33 = r0.append(r1);
    ...
    L_0x00b5:
        ...
        r0 = r0.field;
        r32 = r0;
        r32 = r32.getStaticFlag();
        if (r32 == 0) goto L_0x00fb;
    L_0x00c7:
        r32 = "gnu.kawa.reflect.StaticFieldLocation";
        r20 = gnu.bytecode.ClassType.make(r32);
        r33 = "make";
    ...
    L_0x00d3:
        ...
        r1 = r33;
        r2 = r32;
        r21 = r0.getDeclaredMethod(r1, r2);
    L_0x00dd:
    ...
    L_0x00f8:
        ...
        goto L_0x00d3;
    L_0x00fb:
        r32 = "gnu.kawa.reflect.FieldLocation";
        r20 = gnu.bytecode.ClassType.make(r32);
        r33 = "make";
    ...
    L_0x01a1:
        r18 = r36.getLineNumber();
        if (r18 <= 0) goto L_0x035e;
    L_0x01a7:
        r32 = "gnu.mapping.UnboundLocationException";
        r29 = gnu.bytecode.ClassType.make(r32);
        r17 = r7.isInTry();
        r8 = r36.getColumnNumber();
        r27 = new gnu.bytecode.Label;
        r0 = r27;
        r0.<init>(r7);
        r0 = r27;
        r0.define(r7);
        r32 = gnu.expr.Compilation.getLocationMethod;
        r0 = r32;
        r7.emitInvokeVirtual(r0);
        r10 = new gnu.bytecode.Label;
        r10.<init>(r7);
        r10.define(r7);
        r9 = new gnu.bytecode.Label;
        r9.<init>(r7);
        r9.setTypes(r7);
    ...
    L_0x01e4:
        ...
        r1 = r32;
        r2 = r33;
        r32 = r0.getDeclaredMethod(r1, r2);
        r0 = r32;
        r7.emitInvokeVirtual(r0);
        r7.emitThrow();
    ...
    L_0x0213:
        r9.define(r7);
    L_0x0216:
        r26 = gnu.bytecode.Type.pointer_type;
        goto L_0x00ed;
    L_0x021a:
        r0 = r35;
        r0 = r0.field;
    ...
    L_0x0235:
        ...
        if (r32 != 0) goto L_0x0295;
    L_0x023b:
        r11 = gnu.mapping.Environment.getCurrent();
        r0 = r35;
        r0 = r0.symbol;
        r32 = r0;
        r0 = r32;
    ...
    L_0x024d:
        ...
        r0 = r0.symbol;
        r32 = r0;
        r32 = (gnu.mapping.Symbol) r32;
        r28 = r32;
    L_0x0257:
        r24 = 0;
        r32 = r35.isProcedureDecl();
        if (r32 == 0) goto L_0x026b;
    L_0x025f:
        r32 = r38.getLanguage();
        r32 = r32.hasSeparateFunctionNamespace();
        if (r32 == 0) goto L_0x026b;
    L_0x0269:
        r24 = gnu.mapping.EnvironmentKey.FUNCTION;
    L_0x026b:
        r0 = r28;
        r1 = r24;
        r19 = r11.getLocation(r0, r1);
        r32 = gnu.expr.Compilation.typeLocation;
        r32 = gnu.expr.Target.pushValue(r32);
        r0 = r38;
        r1 = r19;
        r2 = r32;
    ...
    L_0x02ae:
        ...
        r0 = r0.value;
        r32 = r0;
        r33 = gnu.expr.QuoteExp.undefined_exp;
        r0 = r32;
        r1 = r33;
    ...
    L_0x030b:
        r32 = 128; // 0x80 float:1.794E-43 double:6.32E-322;
        r0 = r35;
        r1 = r32;
        r32 = r0.getFlag(r1);
        if (r32 != 0) goto L_0x0345;
    L_0x0317:
        ...
        r32 = r6.isMakingClassPair();
        if (r32 == 0) goto L_0x0345;
    L_0x0323:
        r32 = "get";
        r33 = r35.getName();
        r14 = gnu.expr.ClassExp.slotToMethodName(r32, r33);
        r0 = r6.type;
        r32 = r0;
        r33 = 0;
        r0 = r32;
        r1 = r33;
        r15 = r0.getDeclaredMethod(r14, r1);
        r0 = r38;
        r6.loadHeapFrame(r0);
        r7.emitInvoke(r15);
        goto L_0x018f;
    ...
    public short getAccessFlags(short defaultFlags) {
        ...
        if (getFlag(251658240)) {
            flags = (short) 0;
            if (getFlag(16777216)) {
                flags = (short) CAN_READ;
            }
            if (getFlag(33554432)) {
                flags = (short) (flags | CAN_CALL);
            }
            if (getFlag(67108864)) {
                flags = (short) (flags | INDIRECT_BINDING);
            }
        } else {
            flags = defaultFlags;
        }
        if (getFlag(VOLATILE_ACCESS)) {
            flags = (short) (flags | IS_SIMPLE);
        }
        if (getFlag(TRANSIENT_ACCESS)) {
            flags = (short) (flags | PROCEDURE);
        }
        if (getFlag(ENUM_ACCESS)) {
            flags = (short) (flags | IS_CONSTANT);
        }
        if (getFlag(FINAL_ACCESS)) {
            return (short) (flags | IS_FLUID);
        }
        return flags;
    }
    ...
    protected Declaration() {
        int i = counter + INDIRECT_BINDING;
        counter = i;
        this.id = i;
    ...
    public void pushIndirectBinding(Compilation comp) {
        ...
        if (this.makeLocationMethod == null) {
            Type[] args = new Type[CAN_READ];
            args[0] = Type.pointer_type;
            args[INDIRECT_BINDING] = Type.string_type;
