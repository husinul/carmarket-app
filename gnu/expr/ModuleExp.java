...
public class ModuleExp extends LambdaExp implements Externalizable {
    ...
    public static Class evalToClass(Compilation comp, URL url) throws SyntaxException {
        ...
        try {
            ...
            while (true) {
                if (!(context.getParent() instanceof ArrayClassLoader)) {
                    break;
                }
        ...
        try {
            if (inst == Boolean.TRUE) {
                ...
                if (inst instanceof Class) {
                    ...
                    inst = ModuleContext.getContext().findInstance(cls);
                }
                    ...
                    for (Declaration decl = mexp.firstDecl(); decl != null; decl = decl.nextDecl()) {
                        ...
                        if (!(decl.isPrivate() || dname == null)) {
                            ...
                            if (dname instanceof Symbol) {
                                ...
                                sym = Symbol.make(ElementType.MATCH_ANY_LOCALNAME, dname.toString().intern());
                            }
    ...
    public final boolean isStatic() {
        return getFlag(STATIC_SPECIFIED) || !((Compilation.moduleStatic < 0 && !getFlag(IMMEDIATE)) || getFlag(SUPERTYPE_SPECIFIED) || getFlag(NONSTATIC_SPECIFIED));
    }
