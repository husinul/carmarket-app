...
public class LambdaExp extends ScopeExp {
    ...
    /* renamed from: gnu.expr.LambdaExp.1 */
    class C01841 implements Filter {
        final /* synthetic */ String val$mangled;

        C01841(String str) {
            this.val$mangled = str;
        }

        public boolean select(Object value) {
            Method method = (Method) value;
            if (method.getName().equals(this.val$mangled) && method.getParameterTypes().length == LambdaExp.this.min_args) {
                return true;
            }
            return false;
        }
    ...
    public final boolean getInlineOnly() {
        return (this.flags & INLINE_ONLY) != 0;
    }
    ...
    public final boolean getNeedsStaticLink() {
        return (this.flags & NEEDS_STATIC_LINK) != 0;
    }

    public final void setNeedsStaticLink(boolean needsStaticLink) {
        if (needsStaticLink) {
            this.flags |= NEEDS_STATIC_LINK;
        } else {
            this.flags &= -17;
        }
    }
    ...
    public final boolean getImportsLexVars() {
        return (this.flags & IMPORTS_LEX_VARS) != 0;
    }

    public final void setImportsLexVars(boolean importsLexVars) {
        if (importsLexVars) {
            this.flags |= IMPORTS_LEX_VARS;
        } else {
            this.flags &= -9;
        }
    }
    ...
    public final void setImportsLexVars() {
        int old = this.flags;
        this.flags |= IMPORTS_LEX_VARS;
        if ((old & IMPORTS_LEX_VARS) == 0 && this.nameDecl != null) {
    ...
    public final void setNeedsStaticLink() {
        int old = this.flags;
        this.flags |= NEEDS_STATIC_LINK;
        if ((old & NEEDS_STATIC_LINK) == 0 && this.nameDecl != null) {
            setCallersNeedStaticLink();
        }
    }
    ...
    public final boolean isClassMethod() {
        return (this.flags & CLASS_METHOD) != 0;
    }

    public final void setClassMethod(boolean isMethod) {
        if (isMethod) {
            this.flags |= CLASS_METHOD;
        } else {
            this.flags &= -65;
        }
    }
    ...
    public int getCallConvention() {
        if (isModuleBody()) {
            if (Compilation.defaultCallConvention >= CAN_READ) {
    ...
    public int incomingArgs() {
        return (this.min_args != this.max_args || this.max_args > CAN_CALL || this.max_args <= 0) ? 1 : this.max_args;
    }
    ...
    Field allocFieldFor(Compilation comp) {
        ...
        if (this.nameDecl == null || !(this.nameDecl.context instanceof ModuleExp)) {
            ...
            if (!needsClosure) {
                fflags = NEEDS_STATIC_LINK | IMPORTS_LEX_VARS;
            }
        } else {
            ...
            if ((this.flags & OVERLOADABLE_FIELD) != 0) {
                String fname0 = fname;
    ...
    public void compile(Compilation comp, Target target) {
        if (!(target instanceof IgnoreTarget)) {
            ...
            if ((this.flags & NO_FIELD) != 0 || (comp.immediate && (outer instanceof ModuleExp))) {
                if (this.primMethods == null) {
                    allocMethod(outerLambda(), comp);
                }
                compileAsMethod(comp);
    ...
    void enterFunction(Compilation comp) {
        ...
        if (this.min_args == this.max_args && this.primMethods == null && getCallConvention() < CAN_READ) {
            argsArray = null;
        }
        int i = 0;
                            ...
                            if (i < this.min_args + opt_args) {
                                ...
                                if (defaultArg instanceof QuoteExp) {
                                    if (searchForKeywordMethod4 == null) {
                                        argts = new Type[CAN_CALL];
                                        argts[0] = Compilation.objArrayType;
                                        argts[1] = Type.intType;
                                        argts[CAN_READ] = Type.objectType;
    ...
    void compileAsMethod(Compilation comp) {
        if ((this.flags & METHODS_COMPILED) == 0 && !isAbstract()) {
            this.flags |= METHODS_COMPILED;
            if (this.primMethods != null) {
                int k;
                Declaration decl;
                int k2;
                ...
                boolean ctxArg = getCallConvention() >= CAN_READ;
    ...
    /* JADX WARNING: inconsistent code. */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public gnu.expr.Expression validateApply(gnu.expr.ApplyExp r23, gnu.expr.InlineCalls r24, gnu.bytecode.Type r25, gnu.expr.Declaration r26) {
        /*
        r22 = this;
        r4 = r23.getArgs();
        r0 = r22;
    ...
    L_0x0012:
        ...
        r0 = r22;
        r1 = r19;
        r11 = gnu.expr.InlineCalls.inlineCall(r0, r4, r1);
    ...
    L_0x0027:
        ...
        r1 = r20;
        r2 = r21;
        r16 = gnu.mapping.WrongArguments.checkArgCount(r0, r1, r2, r5);
    ...
    L_0x004f:
        ...
        goto L_0x0026;
    L_0x0058:
        r8 = r22.getCallConvention();
        r7 = r24.getCompilation();
        r0 = r22;
        r19 = r7.inlineOk(r0);
        if (r19 == 0) goto L_0x0026;
    L_0x0068:
        r19 = r22.isClassMethod();
        if (r19 == 0) goto L_0x0026;
    L_0x006e:
        r19 = 2;
        r0 = r19;
    ...
    L_0x009c:
        ...
        r6 = r0.outer;
        r6 = (gnu.expr.ClassExp) r6;
        r19 = r6.isMakingClassPair();
        if (r19 == 0) goto L_0x00a8;
    L_0x00a8:
        r15 = new gnu.expr.PrimProcedure;
        r0 = r22;
        r15.<init>(r14, r0);
    ...
    L_0x00b5:
        ...
        goto L_0x0026;
    L_0x00c6:
        r9 = r24.getCurrentLambda();
    L_0x00ca:
        if (r9 != 0) goto L_0x00ed;
    L_0x00cc:
        r19 = new java.lang.StringBuilder;
        r19.<init>();
        r20 = "internal error: missing ";
        r19 = r19.append(r20);
        r0 = r19;
        r1 = r22;
        r19 = r0.append(r1);
    ...
    L_0x0103:
        r19 = r10.isThisParameter();
        if (r19 != 0) goto L_0x013d;
    L_0x0109:
        r19 = new java.lang.StringBuilder;
        r19.<init>();
        r20 = "calling non-static method ";
        r19 = r19.append(r20);
        r20 = r22.getName();
        r19 = r19.append(r20);
        r20 = " from static method ";
        r19 = r19.append(r20);
        r20 = r9.getName();
        r19 = r19.append(r20);
        r19 = r19.toString();
    ...
    L_0x013d:
        ...
        r19 = r17 + 1;
        r0 = r19;
        r13 = new gnu.expr.Expression[r0];
        r19 = r23.getArgs();
        r20 = 0;
        r21 = 1;
        r0 = r19;
        ...
        r2 = r21;
        r3 = r17;
        java.lang.System.arraycopy(r0, r1, r13, r2, r3);
        r19 = 0;
        r20 = new gnu.expr.ThisExp;
        r0 = r20;
        r0.<init>(r10);
        r13[r19] = r20;
        goto L_0x00b5;
        */
        throw new UnsupportedOperationException("Method not decompiled: gnu.expr.LambdaExp.validateApply(gnu.expr.ApplyExp, gnu.expr.InlineCalls, gnu.bytecode.Type, gnu.expr.Declaration):gnu.expr.Expression");
    }

    public void print(OutPort out) {
        int opt_i;
        out.startLogicalBlock("(Lambda/", ")", (int) CAN_READ);
