...
public class CallContext {
    ...
    Object getArgAsObject(int i) {
        if (i < 8) {
            switch ((this.where >> (i * ARG_IN_VALUE4)) & 15) {
                case ARG_IN_VALUE1 /*1*/:
                    return this.value1;
                case ARG_IN_VALUE2 /*2*/:
                    return this.value2;
                case ARG_IN_VALUE3 /*3*/:
                    return this.value3;
                case ARG_IN_VALUE4 /*4*/:
                    return this.value4;
                case ARG_IN_IVALUE1 /*5*/:
                    return IntNum.make(this.ivalue1);
                case ARG_IN_IVALUE2 /*6*/:
    ...
    public final Object[] getRestArgsArray(int next) {
        ...
        while (next < this.count) {
            int i2 = i + ARG_IN_VALUE1;
            int next2 = next + ARG_IN_VALUE1;
    ...
    public Object[] getArgs() {
        ...
        for (int i = 0; i < n; i += ARG_IN_VALUE1) {
            args[i] = getNextArg();
        }
        return args;
    }
    ...
    public final int startFromContext() {
        ...
        vst.ensureSpace(ARG_IN_VALUE3);
        int i = vst.gapStart;
        int gapStart = i + ARG_IN_VALUE1;
        vst.data[i] = '\uf102';
        vst.setIntN(gapStart, oindex);
        i = gapStart + ARG_IN_VALUE2;
        this.consumer = vst;
        vst.gapStart = i;
        return i;
    }
