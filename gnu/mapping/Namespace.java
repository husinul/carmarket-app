...
public class Namespace implements Externalizable, HasNamedParts {
    ...
    static {
        ...
        EmptyNamespace = valueOf(ElementType.MATCH_ANY_LOCALNAME);
    }
    ...
    public static Namespace makeUnknownNamespace(String prefix) {
        String uri;
        if (prefix == null || prefix == ElementType.MATCH_ANY_LOCALNAME) {
    ...
    public String toString() {
        ...
        sbuf.append('\"');
        if (!(this.prefix == null || this.prefix == ElementType.MATCH_ANY_LOCALNAME)) {
            sbuf.append(' ');
