...
public class NodeUtils {
    ...
    public static void prefixesFromNodetype(XName name, Consumer out) {
        ...
        for (NamespaceBinding ns = bindings; ns != null; ns = ns.getNext()) {
            if (ns.getUri() != null) {
                ...
                if (prefix == null) {
                    prefix = ElementType.MATCH_ANY_LOCALNAME;
                }
    ...
    public static boolean lang(Object testlang, Object node) {
        ...
        if (testlang == null || testlang == Values.empty) {
            teststr = ElementType.MATCH_ANY_LOCALNAME;
        } else {
    ...
    static Object getIDs(Object arg, Object collector) {
        ...
        if (arg instanceof Values) {
            ...
            String str = StringUtils.coerceToString(arg, "fn:id", 1, ElementType.MATCH_ANY_LOCALNAME);
            int len = str.length();
            int i2 = 0;
    ...
    static {
        collectionNamespace = "http://gnu.org/kawa/cached-collections";
        collectionResolverSymbol = Symbol.make(XQuery.LOCAL_NAMESPACE, "collection-resolver", "qexo");
    }
