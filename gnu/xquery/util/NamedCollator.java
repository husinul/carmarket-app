    ...
    public static int codepointCompare(String str1, String str2) {
        ...
        while (i1 != len1) {
            ...
            if (c1 >= 55296 && c1 < 56320 && i2 < len1) {
                c1 = (((c1 - 55296) * LambdaExp.SEQUENCE_RESULT) + (str1.charAt(i2) - 56320)) + ModuleExp.NONSTATIC_SPECIFIED;
                i2++;
            }
            i = i22 + 1;
            int c2 = str2.charAt(i22);
            if (c2 >= 55296 && c2 < 56320 && i < len2) {
                c2 = (((c2 - 55296) * LambdaExp.SEQUENCE_RESULT) + (str2.charAt(i) - 56320)) + ModuleExp.NONSTATIC_SPECIFIED;
                i++;
            }
            if (c1 != c2) {
                return c1 < c2 ? -1 : 1;
