...
public class XQuery extends Language {
    ...
    static {
        xqueryFunctionNamespace = Namespace.valueOf(XQUERY_FUNCTION_NAMESPACE);
        kawaFunctionNamespace = Namespace.valueOf(KAWA_FUNCTION_NAMESPACE);
        qexoFunctionNamespace = Namespace.valueOf(QEXO_FUNCTION_NAMESPACE);
    ...
    public boolean parse(Compilation tr, int options) throws IOException, SyntaxException {
        ...
        if (parser.isInteractive()) {
            ...
            mexp.body = sexp;
        } else if ((PARSE_WITH_FOCUS & options) != 0) {
    ...
    public boolean hasNamespace(Declaration decl, int namespace) {
        ...
        return dnspace == namespace || ((dnspace == VARIADIC_FUNCTION_NAMESPACE && (namespace & 2) != 0) || (namespace == VARIADIC_FUNCTION_NAMESPACE && (dnspace & 2) != 0));
    }
    ...
    public static Object getExternal(Symbol name, Object type) {
        ...
        if (value == null) {
            ...
            try {
                ...
                throw new WrongType(name.toString(), (int) VARIADIC_FUNCTION_NAMESPACE, value, type.toString());
            }
        }
    }
}
