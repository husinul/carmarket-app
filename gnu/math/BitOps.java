...
public class BitOps {
    ...
    static {
        bit4_count = new byte[]{(byte) 0, (byte) 1, (byte) 1, (byte) 2, (byte) 1, (byte) 2, (byte) 2, (byte) 3, (byte) 1, (byte) 2, (byte) 2, (byte) 3, (byte) 2, (byte) 3, (byte) 3, (byte) 4};
    }
    ...
    public static IntNum reverseBits(IntNum x, int start, int end) {
        ...
        if (x.words != null || end >= 63) {
            ...
            for (j = end - 1; i < j; j--) {
                ...
                int biti = (wi >> i) & 1;
                if (ii == jj) {
                    long j2 = ((long) wi) & (((1 << i) | (1 << j)) ^ -1);
                    int i2 = biti << j;
                    wi = (i2 | ((int) r18)) | (((wi >> j) & 1) << i);
                } else {
                    int wj = data[jj];
                    int bitj = (wj >> (j & 31)) & 1;
