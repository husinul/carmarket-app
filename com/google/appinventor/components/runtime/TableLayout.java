...
public class TableLayout implements Layout {
    ...
    /* renamed from: com.google.appinventor.components.runtime.TableLayout.1 */
    class C00821 implements Runnable {
        final /* synthetic */ AndroidViewComponent val$child;

        C00821(AndroidViewComponent androidViewComponent) {
            this.val$child = androidViewComponent;
        }

        public void run() {
            TableLayout.this.addChild(this.val$child);
        }
    }
    ...
    private void addChildLater(AndroidViewComponent child) {
        this.handler.post(new C00821(child));
    }
