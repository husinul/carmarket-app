...
public final class VideoPlayer extends AndroidViewComponent implements OnDestroyListener, Deleteable, OnCompletionListener, OnErrorListener, OnPreparedListener {
    ...
    class ResizableVideoView extends VideoView {
        ...
        /* renamed from: com.google.appinventor.components.runtime.VideoPlayer.ResizableVideoView.1 */
        class C01121 implements Runnable {
            final /* synthetic */ int val$specheight;
            final /* synthetic */ int val$specwidth;
            final /* synthetic */ int val$trycount;

            C01121(int i, int i2, int i3) {
                this.val$specwidth = i;
                this.val$specheight = i2;
                this.val$trycount = i3;
            }

            public void run() {
                ResizableVideoView.this.onMeasure(this.val$specwidth, this.val$specheight, this.val$trycount + 1);
            }
        }

        /* renamed from: com.google.appinventor.components.runtime.VideoPlayer.ResizableVideoView.2 */
        class C01132 implements Runnable {
            final /* synthetic */ int val$specheight;
            final /* synthetic */ int val$specwidth;
            final /* synthetic */ int val$trycount;

            C01132(int i, int i2, int i3) {
                this.val$specwidth = i;
                this.val$specheight = i2;
                this.val$trycount = i3;
            }
        ...
        private void onMeasure(int specwidth, int specheight, int trycount) {
            ...
            Log.i("VideoPlayer..onMeasure", "AI setting dimensions as:" + r0 + ":" + this.forcedHeight);
            ...
            if (this.forcedWidth <= Component.LENGTH_PERCENT_TAG) {
                ...
                if (cWidth != 0 || trycount >= 2) {
                    ...
                    VideoPlayer.this.androidUIHandler.postDelayed(new C01121(specwidth, specheight, trycount), 100);
            ...
            if (this.forcedHeight <= Component.LENGTH_PERCENT_TAG) {
                ...
                if (cHeight != 0 || trycount >= 2) {
                    ...
                    VideoPlayer.this.androidUIHandler.postDelayed(new C01132(specwidth, specheight, trycount), 100);
                    setMeasuredDimension(100, 100);
                    return;
                }
            } else if (scaleHeight) {
    ...
    public VideoPlayer(ComponentContainer container) {
        ...
        this.sourcePath = ElementType.MATCH_ANY_LOCALNAME;
    }
    ...
    public void FullScreen(boolean value) {
        if (value && SdkLevel.getLevel() <= 4) {
            ...
            if (value) {
                ...
                this.inFullScreen = false;
                this.container.$form().dispatchErrorOccurredEvent(this, "FullScreen", ErrorMessages.ERROR_VIDEOPLAYER_FULLSCREEN_UNAVAILBLE, ElementType.MATCH_ANY_LOCALNAME);
                return;
            }
            ...
            this.inFullScreen = true;
            this.container.$form().dispatchErrorOccurredEvent(this, "FullScreen", ErrorMessages.ERROR_VIDEOPLAYER_FULLSCREEN_CANT_EXIT, ElementType.MATCH_ANY_LOCALNAME);
        }
    }
