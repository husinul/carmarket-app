...
public abstract class Sprite extends VisibleComponent implements AlarmHandler, OnDestroyListener, Deleteable {
    ...
    /* renamed from: com.google.appinventor.components.runtime.Sprite.1 */
    class C00811 implements Runnable {
        final /* synthetic */ Object[] val$args;
        final /* synthetic */ String val$eventName;
        final /* synthetic */ Sprite val$sprite;

        C00811(Sprite sprite, String str, Object[] objArr) {
        ...
        public void run() {
            EventDispatcher.dispatchEvent(this.val$sprite, this.val$eventName, this.val$args);
        }
    }
    ...
    protected Sprite(ComponentContainer container, Handler handler) {
        ...
        if (container instanceof Canvas) {
            ...
            this.timerInternal = new TimerInternal(this, DEFAULT_VISIBLE, DEFAULT_INTERVAL, handler);
            this.form = container.$form();
            Heading(0.0d);
            Enabled(DEFAULT_VISIBLE);
    ...
    public void Initialize() {
        this.initialized = DEFAULT_VISIBLE;
    ...
    protected void postEvent(Sprite sprite, String eventName, Object... args) {
        this.androidUIHandler.post(new C00811(sprite, eventName, args));
    }
    ...
    private final boolean overWestEdge() {
        return this.xLeft < 0.0d ? DEFAULT_VISIBLE : false;
    }

    private final boolean overEastEdge(int canvasWidth) {
        return this.xLeft + ((double) Width()) > ((double) canvasWidth) ? DEFAULT_VISIBLE : false;
    }

    private final boolean overNorthEdge() {
        return this.yTop < 0.0d ? DEFAULT_VISIBLE : false;
    }

    private final boolean overSouthEdge(int canvasHeight) {
        return this.yTop + ((double) Height()) > ((double) canvasHeight) ? DEFAULT_VISIBLE : false;
    }
    ...
    public boolean intersectsWith(BoundingBox rect) {
        BoundingBox rect1 = getBoundingBox(DEFAULT_HEADING);
    ...
    public boolean containsPoint(double qx, double qy) {
        return (qx < this.xLeft || qx >= this.xLeft + ((double) Width()) || qy < this.yTop || qy >= this.yTop + ((double) Height())) ? false : DEFAULT_VISIBLE;
    }
