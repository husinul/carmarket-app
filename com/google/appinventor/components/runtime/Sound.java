...
public class Sound extends AndroidNonvisibleComponent implements Component, OnResumeListener, OnStopListener, OnDestroyListener, Deleteable {
    ...
    public Sound(ComponentContainer container) {
        ...
        this.soundPool = new SoundPool(MAX_STREAMS, 3, LOOP_MODE_NO_LOOP);
    ...
    public void Source(String path) {
        ...
        if (this.streamId != 0) {
            ...
            this.streamId = LOOP_MODE_NO_LOOP;
        }
        this.soundId = LOOP_MODE_NO_LOOP;
    ...
    private void playAndCheckResult() {
        this.streamId = this.soundPool.play(this.soundId, VOLUME_FULL, VOLUME_FULL, LOOP_MODE_NO_LOOP, LOOP_MODE_NO_LOOP, VOLUME_FULL);
