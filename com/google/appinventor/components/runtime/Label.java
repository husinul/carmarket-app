...
public final class Label extends AndroidViewComponent {
    ...
    public Label(ComponentContainer container) {
        ...
        if (lp instanceof LayoutParams) {
            ...
            this.defaultLabelMarginInDp = dpToPx(this.view, DEFAULT_LABEL_MARGIN);
        } else {
            this.defaultLabelMarginInDp = 0;
        ...
        TextColor(ListPicker.DEFAULT_ITEM_BACKGROUND_COLOR);
        HTMLFormat(false);
        HasMargins(true);
    }
    ...
    public void TextColor(int argb) {
        ...
        if (argb != 0) {
            ...
            TextViewUtil.setTextColor(this.view, ListPicker.DEFAULT_ITEM_BACKGROUND_COLOR);
        }
    }
}
