...
public final class ErrorMessages {
    ...
    static {
        ...
        errorMessages.put(Integer.valueOf(ERROR_FUNCTIONALITY_NOT_SUPPORTED_CONTACT_EMAIL), "Warning: This app contains functionality that does not work on this phone: picking an EmailAddress.");
        errorMessages.put(Integer.valueOf(ERROR_FUNCTIONALITY_NOT_SUPPORTED_EMAIL_PICKER), "Warning: This app contains functionality that does not work on this phone: the EmailPicker component.");
        errorMessages.put(Integer.valueOf(ERROR_FUNCTIONALITY_NOT_SUPPORTED_FUSIONTABLES_CONTROL), "Warning: This app contains functionality that does not work on this phone: the FusiontablesControl component.");
        errorMessages.put(Integer.valueOf(ERROR_FUNCTIONALITY_NOT_SUPPORTED_WEB_COOKIES), "Warning: This app contains functionality that does not work on this phone: using cookies in the Web component.");
        errorMessages.put(Integer.valueOf(ERROR_FUNCTIONALITY_NOT_SUPPORTED_WIFI_DIRECT), "Warning: This app contains functionality that does not work on this phone: Wi-Fi peer-to-peer connectivity.");
        ...
        errorMessages.put(Integer.valueOf(ERROR_TWITTER_INVALID_IMAGE_PATH), "Invalid Path to Image; Update will not be sent.");
        ...
        errorMessages.put(Integer.valueOf(ERROR_NXT_ERROR_CODE_RECEIVED), "Error code received from robot: %s.");
        ...
        errorMessages.put(Integer.valueOf(ERROR_BLUETOOTH_COULD_NOT_FIT_NUMBER_IN_BYTES), "Could not fit \"%s\" into %s bytes.");
