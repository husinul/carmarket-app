...
public class FullScreenVideoUtil implements OnCompletionListener, OnPreparedListener {
    ...
    private LayoutParams mMediaControllerParams;

    /* renamed from: com.google.appinventor.components.runtime.util.FullScreenVideoUtil.1 */
    class C01441 extends Dialog {
        C01441(Context x0, int x1) {
            super(x0, x1);
        }
    ...
    class C01452 extends Dialog {
        C01452(Context x0, int x1) {
            super(x0, x1);
        }
    ...
    public FullScreenVideoUtil(Form form, Handler handler) {
        this.mMediaControllerParams = new LayoutParams(-1, -2, 80);
        this.mFullScreenPlayer = null;
        this.mForm = form;
        this.mHandler = handler;
        if (SdkLevel.getLevel() > 4) {
            this.mFullScreenVideoDialog = new C01441(this.mForm, 16973831);
        } else {
            this.mFullScreenVideoDialog = new C01452(this.mForm, 16973831);
        }
    }
