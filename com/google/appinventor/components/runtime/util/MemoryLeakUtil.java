...
public class MemoryLeakUtil {
    ...
    private static final AtomicInteger prefixGenerator;

    static {
        prefixGenerator = new AtomicInteger(0);
    ...
    public static boolean isTrackedObjectCollected(String key, boolean stopTrackingIfCollected) {
        ...
        if (ref != null) {
            Object o = ref.get();
            Log.i(LOG_TAG, "Object with tag " + key.substring(key.indexOf("_") + 1) + " has " + (o != null ? "not " : ElementType.MATCH_ANY_LOCALNAME) + "been garbage collected.");
