...
public abstract class LegoMindstormsNxtSensor extends LegoMindstormsNxtBase {
    ...
    protected final void setSensorPort(String sensorPortLetter) {
        ...
        try {
            ...
            Form form = this.form;
            Object[] objArr = new Object[SENSOR_TYPE_SWITCH];
            objArr[SENSOR_TYPE_NO_SENSOR] = sensorPortLetter;
            form.dispatchErrorOccurredEvent(this, functionName, ErrorMessages.ERROR_NXT_INVALID_SENSOR_PORT, objArr);
        }
    }
