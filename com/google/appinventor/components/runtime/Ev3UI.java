...
public class Ev3UI extends LegoMindstormsEv3Base {
    ...
    public void FillScreen(int color) {
        ...
        if (color == 0 || color == 1) {
            int i = 0;
            int i2 = 0;
            sendCommand(functionName, Ev3BinaryParser.encodeDirectCommand(Opcode.UI_DRAW, false, i, i2, "cccc", Byte.valueOf(UIDrawSubcode.FILLWINDOW), Byte.valueOf((byte) color), Short.valueOf((short) 0), Short.valueOf((short) 0)), false);
            i = 0;
            i2 = 0;
            sendCommand(functionName, Ev3BinaryParser.encodeDirectCommand(Opcode.UI_DRAW, false, i, i2, "c", Byte.valueOf((byte) 0)), false);
            return;
