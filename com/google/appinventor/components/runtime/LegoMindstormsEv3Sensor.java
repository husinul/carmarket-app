...
public class LegoMindstormsEv3Sensor extends LegoMindstormsEv3Base {
    ...
    protected final int readInputPercentage(String functionName, int layer, int no, int type, int mode) {
        ...
        byte[] reply = sendCommand(functionName, Ev3BinaryParser.encodeDirectCommand(SystemCommand.LIST_FILES, true, 1, 0, "ccccccg", Byte.valueOf(UIWriteSubcode.LED), Byte.valueOf((byte) layer), Byte.valueOf((byte) no), Byte.valueOf((byte) type), Byte.valueOf((byte) mode), Byte.valueOf((byte) 1), Byte.valueOf((byte) 0)), true);
    ...
    protected final double readInputSI(String functionName, int layer, int no, int type, int mode) {
        ...
        byte[] reply = sendCommand(functionName, Ev3BinaryParser.encodeDirectCommand(SystemCommand.LIST_FILES, true, 4, 0, "ccccccg", Byte.valueOf(UIWriteSubcode.POWER), Byte.valueOf((byte) layer), Byte.valueOf((byte) no), Byte.valueOf((byte) type), Byte.valueOf((byte) mode), Byte.valueOf((byte) 1), Byte.valueOf((byte) 0)), true);
