...
public abstract class ButtonBase extends AndroidViewComponent implements OnClickListener, OnFocusChangeListener, OnLongClickListener, OnTouchListener {
    ...
    static {
        ROUNDED_CORNERS_ARRAY = new float[]{ROUNDED_CORNERS_RADIUS, ROUNDED_CORNERS_RADIUS, ROUNDED_CORNERS_RADIUS, ROUNDED_CORNERS_RADIUS, ROUNDED_CORNERS_RADIUS, ROUNDED_CORNERS_RADIUS, ROUNDED_CORNERS_RADIUS, ROUNDED_CORNERS_RADIUS};
    }
    ...
    public ButtonBase(ComponentContainer container) {
        ...
        TextAlignment(1);
        BackgroundColor(0);
        Image(ElementType.MATCH_ANY_LOCALNAME);
        Enabled(true);
        this.fontTypeface = 0;
    ...
    private void setShape() {
        ...
        drawable.getPaint().setColor(this.backgroundColor == 0 ? SHAPED_DEFAULT_BACKGROUND_COLOR : this.backgroundColor);
        switch (this.shape) {
