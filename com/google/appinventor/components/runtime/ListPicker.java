...
public class ListPicker extends Picker implements ActivityResultListener, Deleteable, OnResumeListener {
    ...
    static {
        LIST_ACTIVITY_CLASS = ListPickerActivity.class.getName();
    ...
    public ListPicker(ComponentContainer container) {
        ...
        this.title = ElementType.MATCH_ANY_LOCALNAME;
        this.resumedFromListFlag = DEFAULT_ENABLED;
        this.items = new YailList();
        SelectionIndex(0);
        this.itemTextColor = DEFAULT_ITEM_TEXT_COLOR;
    ...
    public Intent getIntent() {
        ...
        if (!this.title.equals(ElementType.MATCH_ANY_LOCALNAME)) {
    ...
    public void resultReturned(int requestCode, int resultCode, Intent data) {
        if (requestCode == this.requestCode && resultCode == DEFAULT_ITEM_TEXT_COLOR) {
