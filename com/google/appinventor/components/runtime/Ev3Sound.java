...
public class Ev3Sound extends LegoMindstormsEv3Base {
    ...
    public void PlayTone(int volume, int frequency, int milliseconds) {
        ...
        int i = 0;
        sendCommand(functionName, Ev3BinaryParser.encodeDirectCommand(SystemCommand.BEGIN_UPLOAD, true, 0, i, "cccc", Byte.valueOf((byte) 1), Byte.valueOf((byte) volume), Short.valueOf((short) frequency), Short.valueOf((short) milliseconds)), true);
    }
    ...
    public void StopSound() {
        int i = 0;
        int i2 = 0;
        sendCommand(Thread.currentThread().getStackTrace()[1].getMethodName(), Ev3BinaryParser.encodeDirectCommand(SystemCommand.BEGIN_UPLOAD, false, i, i2, "c", Byte.valueOf((byte) 0)), false);
    }
}
