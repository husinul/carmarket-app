...
public class NxtColorSensor extends LegoMindstormsNxtSensor implements Deleteable {
        ...
        public void run() {
            if (NxtColorSensor.this.bluetooth != null && NxtColorSensor.this.bluetooth.IsConnected()) {
                ...
                if (NxtColorSensor.this.detectColor) {
                    sensorValue = NxtColorSensor.this.getColorValue(ElementType.MATCH_ANY_LOCALNAME);
                    ...
                    sensorValue = NxtColorSensor.this.getLightValue(ElementType.MATCH_ANY_LOCALNAME);
                    if (sensorValue.valid) {
                        State currentState;
    ...
    static {
        ...
        mapColorToSensorType.put(Integer.valueOf(Component.COLOR_RED), Integer.valueOf(SENSOR_TYPE_COLOR_RED));
        mapColorToSensorType.put(Integer.valueOf(Component.COLOR_GREEN), Integer.valueOf(SENSOR_TYPE_COLOR_GREEN));
        mapColorToSensorType.put(Integer.valueOf(Component.COLOR_BLUE), Integer.valueOf(SENSOR_TYPE_COLOR_BLUE));
        mapColorToSensorType.put(Integer.valueOf(Component.COLOR_NONE), Integer.valueOf(SENSOR_TYPE_COLOR_NONE));
        mapSensorValueToColor = new HashMap();
        mapSensorValueToColor.put(Integer.valueOf(1), Integer.valueOf(ListPicker.DEFAULT_ITEM_BACKGROUND_COLOR));
    ...
    protected void initializeSensor(String functionName) {
        setInputMode(functionName, this.port, this.detectColor ? SENSOR_TYPE_COLOR_FULL : ((Integer) mapColorToSensorType.get(Integer.valueOf(this.generateColor))).intValue(), 0);
