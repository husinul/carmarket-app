...
public final class WebViewer extends AndroidViewComponent {
    ...
    public String CurrentUrl() {
        return this.webview.getUrl() == null ? ElementType.MATCH_ANY_LOCALNAME : this.webview.getUrl();
    }

    @SimpleProperty(category = PropertyCategory.BEHAVIOR, description = "Title of the page currently viewed")
    public String CurrentPageTitle() {
        return this.webview.getTitle() == null ? ElementType.MATCH_ANY_LOCALNAME : this.webview.getTitle();
    }
