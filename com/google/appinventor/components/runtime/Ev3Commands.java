...
public class Ev3Commands extends LegoMindstormsEv3Base {
    ...
    public double GetBatteryVoltage() {
        byte[] reply = sendCommand(Thread.currentThread().getStackTrace()[1].getMethodName(), Ev3BinaryParser.encodeDirectCommand(SystemCommandType.SYSTEM_COMMAND_NO_REPLY, true, 4, 0, "cg", Byte.valueOf((byte) 1), Byte.valueOf((byte) 0)), true);
    ...
    public double GetBatteryCurrent() {
        byte[] reply = sendCommand(Thread.currentThread().getStackTrace()[1].getMethodName(), Ev3BinaryParser.encodeDirectCommand(SystemCommandType.SYSTEM_COMMAND_NO_REPLY, true, 4, 0, "cg", Byte.valueOf((byte) 2), Byte.valueOf((byte) 0)), true);
        if (reply != null && reply.length == 5 && reply[0] == (byte) 2) {
            return (double) ((Float) Ev3BinaryParser.unpack("xf", reply)[0]).floatValue();
        }
        return -1.0d;
    ...
    public String GetOSVersion() {
        String functionName = Thread.currentThread().getStackTrace()[1].getMethodName();
        byte[] reply = sendCommand(functionName, Ev3BinaryParser.encodeDirectCommand(SystemCommandType.SYSTEM_COMMAND_NO_REPLY, true, 100, 0, "ccg", Byte.valueOf((byte) 3), Short.valueOf((short) 100), Byte.valueOf((byte) 0)), true);
    ...
    public String GetOSBuild() {
        String functionName = Thread.currentThread().getStackTrace()[1].getMethodName();
        byte[] reply = sendCommand(functionName, Ev3BinaryParser.encodeDirectCommand((byte) 3, true, 100, 0, "ccg", Byte.valueOf(ConstantPool.NAME_AND_TYPE), Short.valueOf((short) 100), Byte.valueOf((byte) 0)), true);
        if (reply != null && reply[0] == (byte) 2) {
            return String.valueOf(Ev3BinaryParser.unpack("xS", reply)[0]);
        }
        this.form.dispatchErrorOccurredEvent(this, functionName, ErrorMessages.ERROR_EV3_INVALID_REPLY, new Object[0]);
    ...
    public String GetFirmwareVersion() {
        String functionName = Thread.currentThread().getStackTrace()[1].getMethodName();
        byte[] reply = sendCommand(functionName, Ev3BinaryParser.encodeDirectCommand(SystemCommandType.SYSTEM_COMMAND_NO_REPLY, true, 100, 0, "ccg", Byte.valueOf((byte) 10), Short.valueOf((short) 100), Byte.valueOf((byte) 0)), true);
        if (reply != null && reply[0] == (byte) 2) {
            return String.valueOf(Ev3BinaryParser.unpack("xS", reply)[0]);
        }
        this.form.dispatchErrorOccurredEvent(this, functionName, ErrorMessages.ERROR_EV3_INVALID_REPLY, new Object[0]);
    ...
    public String GetFirmwareBuild() {
        String functionName = Thread.currentThread().getStackTrace()[1].getMethodName();
        byte[] reply = sendCommand(functionName, Ev3BinaryParser.encodeDirectCommand(SystemCommandType.SYSTEM_COMMAND_NO_REPLY, true, 100, 0, "cg", Byte.valueOf(Opcode.MEMORY_READ), Byte.valueOf((byte) 0)), true);
        if (reply != null && reply[0] == (byte) 2) {
            return String.valueOf(Ev3BinaryParser.unpack("xS", reply)[0]);
        }
        this.form.dispatchErrorOccurredEvent(this, functionName, ErrorMessages.ERROR_EV3_INVALID_REPLY, new Object[0]);
    ...
    public String GetHardwareVersion() {
        String functionName = Thread.currentThread().getStackTrace()[1].getMethodName();
        byte[] reply = sendCommand(functionName, Ev3BinaryParser.encodeDirectCommand(SystemCommandType.SYSTEM_COMMAND_NO_REPLY, true, 100, 0, "ccg", Byte.valueOf((byte) 9), Short.valueOf((short) 100), Byte.valueOf((byte) 0)), true);
        if (reply != null && reply[0] == (byte) 2) {
            return String.valueOf(Ev3BinaryParser.unpack("xS", reply)[0]);
        }
        this.form.dispatchErrorOccurredEvent(this, functionName, ErrorMessages.ERROR_EV3_INVALID_REPLY, new Object[0]);
