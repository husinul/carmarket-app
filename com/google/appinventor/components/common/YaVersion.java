...
public class YaVersion {
    ...
    static {
        String[] strArr = new String[VERTICALARRANGEMENT_COMPONENT_VERSION];
        strArr[0] = "2.37";
        strArr[YANDEX_COMPONENT_VERSION] = "2.38";
        strArr[TINYWEBDB_COMPONENT_VERSION] = PREFERRED_COMPANION;
        ACCEPTABLE_COMPANIONS = strArr;
    }
}
