...
class LogCatCollector {
    ...
    public static String collectLogCat(String bufferName) {
        ...
        try {
            BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(Runtime.getRuntime().exec((String[]) commandLine.toArray(new String[commandLine.size()])).getInputStream()), Declaration.TYPE_SPECIFIED);
