...
public class misc extends ModuleBody {
    ...
    static {
        ...
        null$Mnenvironment = new ModuleMethod(moduleBody, 18, Lit17, LambdaExp.ATTEMPT_INLINE);
        ...
        base$Mnuri = new ModuleMethod(moduleBody, 29, Lit26, LambdaExp.ATTEMPT_INLINE);
