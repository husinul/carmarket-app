...
public class ImportFromLibrary extends Syntax {
    ...
    public ImportFromLibrary() {
        this.classPrefixPath = new String[]{BUILTIN, "kawa.lib."};
    }
    ...
    static {
        ...
        r0[3] = new String[]{"6", "basic-string-ports", BUILTIN};
        r0[4] = new String[]{"8", "receive", BUILTIN};
        r0[5] = new String[]{"9", "records", BUILTIN};
        r0[6] = new String[]{"11", "let-values", BUILTIN};
        r0[7] = new String[]{"13", "strings", "gnu.kawa.slib.srfi13"};
        r0[8] = new String[]{"14", "char-sets", MISSING};
        r0[9] = new String[]{"16", "case-lambda", BUILTIN};
        r0[10] = new String[]{"17", "generalized-set!", BUILTIN};
        ...
        r0[14] = new String[]{"23", "error", BUILTIN};
        r0[15] = new String[]{"25", "multi-dimensional-arrays", BUILTIN};
        r0[16] = new String[]{"26", "cut", BUILTIN};
        r0[17] = new String[]{"27", "random-bits", MISSING};
        r0[18] = new String[]{"28", "basic-format-strings", BUILTIN};
        r0[19] = new String[]{"29", "localization", MISSING};
        r0[20] = new String[]{"31", "rec", MISSING};
        r0[21] = new String[]{"38", "with-shared-structure", MISSING};
        r0[22] = new String[]{"39", "parameters", BUILTIN};
