...
public class Record {
    ...
    public static ClassType makeRecordType(String name, LList fnames) {
        ...
        String str = "<init>";
        Method constructor = clas.addMethod(mangleNameIfNeeded, Type.typeArray0, Type.voidType, 1);
        String str2 = "<init>";
        Method superConstructor = superClass.addMethod(mangleNameIfNeeded, Type.typeArray0, Type.voidType, 1);
        ...
        if (!name.equals(mangledName)) {
            str = "getTypeName";
            code = clas.addMethod(mangleNameIfNeeded, Type.typeArray0, Compilation.typeString, 1).startCode();
        ...
        while (fnames != LList.Empty) {
            ...
            mangleNameIfNeeded = Compilation.mangleNameIfNeeded(fname);
            Type type = Type.pointer_type;
            clas.addField(mangleNameIfNeeded, r21, 1).setSourceName(fname.intern());
