...
public class Quote extends Syntax {
    ...
    static {
        plainQuote = new Quote(LispLanguage.quote_sym, false);
        quasiQuote = new Quote(LispLanguage.quasiquote_sym, true);
    ...
    public Expression rewrite(Object obj, Translator tr) {
        if (obj instanceof Pair) {
            ...
            if (pair.getCdr() == LList.Empty) {
                return coerceExpression(expand(pair.getCar(), this.isQuasi ? 1 : QUOTE_DEPTH, tr), tr);
            }
        }
    ...
    public static Object append$V(Object[] args) {
        ...
        int i = count + QUOTE_DEPTH;
        Object obj = args[count + QUOTE_DEPTH];
        while (true) {
            i += QUOTE_DEPTH;
            if (i < 0) {
                return obj;
